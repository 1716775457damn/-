...
input_size = (224, 224)
labels = ['fama']
anchors = [2.09, 3.03, 1.84, 2.89, 1.72, 2.47, 1.59, 2.25, 1.84, 2.25]
   ...
   # sensor.set_vflip(sensor_vflip)
    ...
    try:
        ...
        while(True):
            ...
            img.draw_string(0, 2, "S Y L U", scale=1.2, color=(255, 0, 0))
            img.draw_string(0, 30, "ZBN", scale=1.2, color=(255, 0, 0))
            lcd.display(img)
...
if __name__ == "__main__":
    try:
        ...
        main(anchors = anchors, labels=labels, model_addr="/sd/model-138945.kmodel")
    except Exception as e:
